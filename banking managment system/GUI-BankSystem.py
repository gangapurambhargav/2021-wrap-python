...
def Cr_Amt(accnt,name):
	...
	fr1=tk.Frame(creditwn,bg="white")
	l_title=tk.Message(creditwn,text="JIMS BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
...
def De_Amt(accnt,name):
	...
	fr1=tk.Frame(debitwn,bg="white")
	l_title=tk.Message(debitwn,text="JIMS BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def disp_tr_hist(accnt):
	...
	l_title=tk.Message(disp_wn,text="JIMS BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def logged_in_menu(accnt,name):
	...
	img6=tk.PhotoImage(file="logoutacc.gif")
...
def log_in(master):
	...
	l_title=tk.Message(loginwn,text="JIMS BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def Create():
	...
	l_title=tk.Message(crwn,text="JIMS BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def Main_Menu():
	...
	rootwn=tk.Tk()
	rootwn.geometry("1600x500")
	rootwn.title("JIMS Bank")
	rootwn.configure(background='black')
	fr1=tk.Frame(rootwn)
	l_title=tk.Message(text="JIMS BANKING\n SYSTEM",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
	imgc1=tk.PhotoImage(file="create.gif")
	imglo=tk.PhotoImage(file="loginacc.gif")
